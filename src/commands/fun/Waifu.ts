...
const standardActionRowButtons = new ActionRowBuilder().addComponents(
  rerollButton,
  saveImage,
  iLostButton
);

const saveImageActionRowButtons = new ActionRowBuilder().addComponents(
  rerollButton,
  iLostButton
);
    ...
    switch (i.componentType) {
      ...
      case ComponentType.Button:
        switch (i.customId) {
          case "next":
            {
              let { endpoint } = endpointTracker.get(
